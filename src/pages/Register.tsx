          ...
          <Card className="card-premium">
            <CardContent className="p-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <Input
                      ...
                      placeholder="••••••••"
                      className="bg-gray-50 border-gray-200 focus:border-primary pr-10"
                      required
                      disabled={isSubmitting}
                    />
                    <button
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button variant="outline" type="button" disabled={isSubmitting} className="border-gray-200 hover:border-primary hover:bg-amber-50">
